...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
    ...
    exit();
      40:	e8 9d 38 00 00       	call   38e2 <exit>
  }
  close(open("usertests.ran", O_CREATE));
      ...
      51:	e8 cc 38 00 00       	call   3922 <open>
      56:	89 04 24             	mov    %eax,(%esp)
      59:	e8 ac 38 00 00       	call   390a <close>
  ...
  exit();
     10d:	e8 d0 37 00 00       	call   38e2 <exit>
...
00000480 <writetest>:
{
  ...
  printf(stdout, "small file test ok\n");
    ...
    exit();
     609:	e8 d4 32 00 00       	call   38e2 <exit>
    ...
    exit();
     620:	e8 bd 32 00 00       	call   38e2 <exit>
    ...
    exit();
     637:	e8 a6 32 00 00       	call   38e2 <exit>
    ...
    exit();
     64e:	e8 8f 32 00 00       	call   38e2 <exit>
...
00000660 <writetest1>:
{
  ...
  printf(stdout, "big files ok\n");
     ...
     7d4:	e8 67 32 00 00       	call   3a40 <printf>
        exit();
     7d9:	e8 04 31 00 00       	call   38e2 <exit>
    ...
    exit();
     7f0:	e8 ed 30 00 00       	call   38e2 <exit>
    ...
    exit();
     807:	e8 d6 30 00 00       	call   38e2 <exit>
    ...
    exit();
     81e:	e8 bf 30 00 00       	call   38e2 <exit>
     ...
     a16:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  pid = fork();
     a2f:	e8 a6 2e 00 00       	call   38da <fork>
  if(pid == 0){
    ...
    close(fds[0]);
     ...
     afe:	e8 ff 2d 00 00       	call   3902 <write>
  ...
  printf(1, "pipe1 ok\n");
     ...
     b61:	e8 da 2e 00 00       	call   3a40 <printf>
      exit();
     b66:	e8 77 2d 00 00       	call   38e2 <exit>
    ...
    exit();
     b8c:	e8 51 2d 00 00       	call   38e2 <exit>
     ...
     b9a:	e8 a1 2e 00 00       	call   3a40 <printf>
        exit();
     b9f:	e8 3e 2d 00 00       	call   38e2 <exit>
...
00000bb0 <preempt>:
{
  ...
  close(pfds[0]);
     ...
     c89:	e8 7c 2c 00 00       	call   390a <close>
  printf(1, "kill... ");
     c8e:	58                   	pop    %eax
     c8f:	5a                   	pop    %edx
  ...
  kill(pid1);
     ...
     c9f:	e8 6e 2c 00 00       	call   3912 <kill>
  kill(pid2);
     ca4:	89 34 24             	mov    %esi,(%esp)
     ca7:	e8 66 2c 00 00       	call   3912 <kill>
  kill(pid3);
     cac:	89 1c 24             	mov    %ebx,(%esp)
     caf:	e8 5e 2c 00 00       	call   3912 <kill>
  printf(1, "wait... ");
     cb4:	59                   	pop    %ecx
     cb5:	5b                   	pop    %ebx
  ...
  wait();
     cc2:	e8 23 2c 00 00       	call   38ea <wait>
  wait();
     cc7:	e8 1e 2c 00 00       	call   38ea <wait>
  wait();
     ccc:	e8 19 2c 00 00       	call   38ea <wait>
  printf(1, "preempt ok\n");
     cd1:	5e                   	pop    %esi
     cd2:	5f                   	pop    %edi
...
00000d80 <mem>:
{
  ...
  ppid = getpid();
     d97:	e8 c6 2b 00 00       	call   3962 <getpid>
     d9c:	89 c6                	mov    %eax,%esi
  if((pid = fork()) == 0){
     d9e:	e8 37 2b 00 00       	call   38da <fork>
    ...
    exit();
     ...
     e2a:	e8 e3 2a 00 00       	call   3912 <kill>
      exit();
     ...
     e3e:	5d                   	pop    %ebp
    wait();
     e3f:	e9 a6 2a 00 00       	jmp    38ea <wait>
...
00000e50 <sharedfd>:
{
  ...
  pid = fork();
     e94:	e8 41 2a 00 00       	call   38da <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  memset(buf, pid==0?'c':'p', sizeof(buf));
     ...
     eaf:	50                   	push   %eax
     eb0:	e8 8b 28 00 00       	call   3740 <memset>
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ecd:	50                   	push   %eax
     ece:	56                   	push   %esi
     ecf:	e8 2e 2a 00 00       	call   3902 <write>
  ...
  close(fd);
     ...
     f06:	e8 ff 29 00 00       	call   390a <close>
  fd = open("sharedfd", 0);
     f0b:	58                   	pop    %eax
     f0c:	5a                   	pop    %edx
     f0d:	6a 00                	push   $0x0
     f0f:	68 d3 41 00 00       	push   $0x41d3
     f14:	e8 09 2a 00 00       	call   3922 <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     f7c:	e8 89 29 00 00       	call   390a <close>
  unlink("sharedfd");
     f81:	c7 04 24 d3 41 00 00 	movl   $0x41d3,(%esp)
     f88:	e8 a5 29 00 00       	call   3932 <unlink>
  if(nc == 10000 && np == 10000){
    ...
    return;
     ...
     ff3:	c3                   	ret    
    exit();
     ff4:	e8 e9 28 00 00       	call   38e2 <exit>
    ...
    exit();
    1007:	e8 d6 28 00 00       	call   38e2 <exit>
    ...
    101b:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i = 0; i < 2; i++){
    ...
    wait();
    107f:	e8 66 28 00 00       	call   38ea <wait>
    1084:	e8 61 28 00 00       	call   38ea <wait>
    1089:	e8 5c 28 00 00       	call   38ea <wait>
    ...
    109f:	e8 7e 28 00 00       	call   3922 <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10c0:	e8 35 28 00 00       	call   38fa <read>
    ...
    10f8:	e8 0d 28 00 00       	call   390a <close>
    if(total != 12*500){
    ...
    1112:	e8 1b 28 00 00       	call   3932 <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    1151:	56                   	push   %esi
    1152:	e8 cb 27 00 00       	call   3922 <open>
      if(fd < 0){
    ...
    1176:	e8 c5 25 00 00       	call   3740 <memset>
    ...
    118b:	56                   	push   %esi
    118c:	e8 71 27 00 00       	call   3902 <write>
    ...
    119e:	75 de                	jne    117e <fourfiles+0x16e>
      exit();
    11a0:	e8 3d 27 00 00       	call   38e2 <exit>
          printf(1, "wrong char\n");
    ...
    11af:	e8 8c 28 00 00       	call   3a40 <printf>
          exit();
    11b4:	e8 29 27 00 00       	call   38e2 <exit>
    ...
    11c2:	e8 79 28 00 00       	call   3a40 <printf>
        exit();
    11c7:	e8 16 27 00 00       	call   38e2 <exit>
      printf(1, "fork failed\n");
    11cc:	53                   	push   %ebx
    11cd:	53                   	push   %ebx
    ...
    11d5:	e8 66 28 00 00       	call   3a40 <printf>
      exit();
    11da:	e8 03 27 00 00       	call   38e2 <exit>
    ...
    11e8:	e8 53 28 00 00       	call   3a40 <printf>
      exit();
    11ed:	e8 f0 26 00 00       	call   38e2 <exit>
    ...
    11fb:	e8 40 28 00 00       	call   3a40 <printf>
          exit();
    1200:	e8 dd 26 00 00       	call   38e2 <exit>
    ...
    1216:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    ...
    pid = fork();
    122a:	e8 ab 26 00 00       	call   38da <fork>
    if(pid < 0){
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    wait();
    124d:	e8 98 26 00 00       	call   38ea <wait>
    1252:	e8 93 26 00 00       	call   38ea <wait>
    1257:	e8 8e 26 00 00       	call   38ea <wait>
    125c:	e8 89 26 00 00       	call   38ea <wait>
  name[0] = name[1] = name[2] = 0;
    ...
    1296:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    1299:	e8 84 26 00 00       	call   3922 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    12bf:	50                   	push   %eax
    12c0:	e8 45 26 00 00       	call   390a <close>
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    12f8:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    12fb:	e8 32 26 00 00       	call   3932 <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    1374:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    1377:	e8 a6 25 00 00       	call   3922 <open>
        if(fd < 0){
    ...
    1386:	50                   	push   %eax
    1387:	e8 7e 25 00 00       	call   390a <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13a3:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13a6:	e8 87 25 00 00       	call   3932 <unlink>
    ...
    13bb:	e8 80 26 00 00       	call   3a40 <printf>
            exit();
    13c0:	e8 1d 25 00 00       	call   38e2 <exit>
    13c5:	8d 76 00             	lea    0x0(%esi),%esi
      exit();
    13c8:	e8 15 25 00 00       	call   38e2 <exit>
    ...
    13d8:	e8 63 26 00 00       	call   3a40 <printf>
        exit();
    13dd:	e8 00 25 00 00       	call   38e2 <exit>
          printf(1, "create failed\n");
    13e2:	51                   	push   %ecx
    13e3:	51                   	push   %ecx
    ...
    13eb:	e8 50 26 00 00       	call   3a40 <printf>
          exit();
    13f0:	e8 ed 24 00 00       	call   38e2 <exit>
      printf(1, "fork failed\n");
    13f5:	53                   	push   %ebx
    13f6:	53                   	push   %ebx
    ...
    13fe:	e8 3d 26 00 00       	call   3a40 <printf>
      exit();
    1403:	e8 da 24 00 00       	call   38e2 <exit>
      } else if((i >= 1 && i < N/2) && fd >= 0){
    ...
    1419:	e8 22 26 00 00       	call   3a40 <printf>
        exit();
    141e:	e8 bf 24 00 00       	call   38e2 <exit>
...
00001430 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1450:	e8 cd 24 00 00       	call   3922 <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    146c:	50                   	push   %eax
    146d:	e8 90 24 00 00       	call   3902 <write>
  close(fd);
    1472:	89 1c 24             	mov    %ebx,(%esp)
    1475:	e8 90 24 00 00       	call   390a <close>
  fd = open("unlinkread", O_RDWR);
    147a:	58                   	pop    %eax
    147b:	5a                   	pop    %edx
    147c:	6a 02                	push   $0x2
    147e:	68 85 42 00 00       	push   $0x4285
    1483:	e8 9a 24 00 00       	call   3922 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    149d:	e8 90 24 00 00       	call   3932 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14ba:	e8 63 24 00 00       	call   3922 <open>
  write(fd1, "yyy", 3);
  ...
  if(write(fd, buf, 10) != 10){
    ...
    150b:	53                   	push   %ebx
    150c:	e8 f1 23 00 00       	call   3902 <write>
  ...
  close(fd);
    ...
    151c:	53                   	push   %ebx
    151d:	e8 e8 23 00 00       	call   390a <close>
  unlink("unlinkread");
    1522:	c7 04 24 85 42 00 00 	movl   $0x4285,(%esp)
    1529:	e8 04 24 00 00       	call   3932 <unlink>
  printf(1, "unlinkread ok\n");
    ...
    exit();
    1554:	e8 89 23 00 00       	call   38e2 <exit>
    ...
    exit();
    1567:	e8 76 23 00 00       	call   38e2 <exit>
    ...
    exit();
    157a:	e8 63 23 00 00       	call   38e2 <exit>
    ...
    exit();
    158d:	e8 50 23 00 00       	call   38e2 <exit>
    ...
    exit();
    15a0:	e8 3d 23 00 00       	call   38e2 <exit>
    ...
    exit();
    15b3:	e8 2a 23 00 00       	call   38e2 <exit>
    15b8:	90                   	nop
...
000015c0 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1613:	50                   	push   %eax
    1614:	e8 e9 22 00 00       	call   3902 <write>
  ...
  close(fd);
    ...
    1628:	53                   	push   %ebx
    1629:	e8 dc 22 00 00       	call   390a <close>
  if(link("lf1", "lf2") < 0){
    162e:	5b                   	pop    %ebx
    162f:	58                   	pop    %eax
    1630:	68 4a 43 00 00       	push   $0x434a
    1635:	68 46 43 00 00       	push   $0x4346
    163a:	e8 03 23 00 00       	call   3942 <link>
  ...
  unlink("lf1");
    ...
    1652:	e8 db 22 00 00       	call   3932 <unlink>
  if(open("lf1", 0) >= 0){
    1657:	58                   	pop    %eax
    1658:	5a                   	pop    %edx
    1659:	6a 00                	push   $0x0
    165b:	68 46 43 00 00       	push   $0x4346
    1660:	e8 bd 22 00 00       	call   3922 <open>
  ...
  fd = open("lf2", 0);
    ...
    167a:	e8 a3 22 00 00       	call   3922 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1699:	50                   	push   %eax
    169a:	e8 5b 22 00 00       	call   38fa <read>
  ...
  close(fd);
    ...
    16ae:	53                   	push   %ebx
    16af:	e8 56 22 00 00       	call   390a <close>
  if(link("lf2", "lf2") >= 0){
    16b4:	58                   	pop    %eax
    16b5:	5a                   	pop    %edx
    16b6:	68 4a 43 00 00       	push   $0x434a
    16bb:	68 4a 43 00 00       	push   $0x434a
    16c0:	e8 7d 22 00 00       	call   3942 <link>
  ...
  unlink("lf2");
    ...
    16d8:	e8 55 22 00 00       	call   3932 <unlink>
  if(link("lf2", "lf1") >= 0){
    16dd:	59                   	pop    %ecx
    16de:	5b                   	pop    %ebx
    16df:	68 46 43 00 00       	push   $0x4346
    16e4:	68 4a 43 00 00       	push   $0x434a
    16e9:	e8 54 22 00 00       	call   3942 <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1702:	e8 3b 22 00 00       	call   3942 <link>
  ...
  printf(1, "linktest ok\n");
    ...
    exit();
    1733:	e8 aa 21 00 00       	call   38e2 <exit>
    ...
    exit();
    1746:	e8 97 21 00 00       	call   38e2 <exit>
    ...
    exit();
    1759:	e8 84 21 00 00       	call   38e2 <exit>
    ...
    exit();
    176c:	e8 71 21 00 00       	call   38e2 <exit>
    ...
    exit();
    177f:	e8 5e 21 00 00       	call   38e2 <exit>
    ...
    exit();
    1792:	e8 4b 21 00 00       	call   38e2 <exit>
    ...
    exit();
    17a5:	e8 38 21 00 00       	call   38e2 <exit>
    ...
    exit();
    17b8:	e8 25 21 00 00       	call   38e2 <exit>
    ...
    exit();
    17cb:	e8 12 21 00 00       	call   38e2 <exit>
    ...
    17db:	bf ab aa aa aa       	mov    $0xaaaaaaab,%edi
{
  ...
  file[2] = '\0';
    ...
    181e:	53                   	push   %ebx
    181f:	e8 fe 20 00 00       	call   3922 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    182e:	83 c6 01             	add    $0x1,%esi
      close(fd);
    1831:	50                   	push   %eax
    1832:	e8 d3 20 00 00       	call   390a <close>
    1837:	83 c4 10             	add    $0x10,%esp
      wait();
    183a:	e8 ab 20 00 00       	call   38ea <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    1852:	e8 db 20 00 00       	call   3932 <unlink>
    pid = fork();
    1857:	e8 7e 20 00 00       	call   38da <fork>
    if(pid && (i % 3) == 1){
    ...
    1881:	53                   	push   %ebx
    1882:	e8 9b 20 00 00       	call   3922 <open>
      if(fd < 0){
    ...
    189d:	e8 9e 21 00 00       	call   3a40 <printf>
        exit();
    18a2:	e8 3b 20 00 00       	call   38e2 <exit>
    ...
    18b9:	e8 84 20 00 00       	call   3942 <link>
    18be:	83 c4 10             	add    $0x10,%esp
      exit();
    18c1:	e8 1c 20 00 00       	call   38e2 <exit>
  ...
  for(i = 0; i < 40; i++){
    ...
    18dc:	e8 61 20 00 00       	call   3942 <link>
    18e1:	83 c4 10             	add    $0x10,%esp
      wait();
    18e4:	e8 01 20 00 00       	call   38ea <wait>
  for(i = 0; i < 40; i++){
  ...
  fd = open(".", 0);
    ...
    190e:	e8 0f 20 00 00       	call   3922 <open>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1925:	57                   	push   %edi
    1926:	56                   	push   %esi
    1927:	e8 ce 1f 00 00       	call   38fa <read>
  ...
  close(fd);
    ...
    1973:	56                   	push   %esi
    1974:	e8 91 1f 00 00       	call   390a <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    199c:	53                   	push   %ebx
    199d:	e8 90 1f 00 00       	call   3932 <unlink>
      unlink(file);
    19a2:	89 1c 24             	mov    %ebx,(%esp)
    19a5:	e8 88 1f 00 00       	call   3932 <unlink>
      unlink(file);
    19aa:	89 1c 24             	mov    %ebx,(%esp)
    19ad:	e8 80 1f 00 00       	call   3932 <unlink>
      unlink(file);
    19b2:	89 1c 24             	mov    %ebx,(%esp)
    19b5:	e8 78 1f 00 00       	call   3932 <unlink>
  ...
  for(i = 0; i < 40; i++){
    19c5:	83 c6 01             	add    $0x1,%esi
      wait();
    19c8:	e8 1d 1f 00 00       	call   38ea <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19d8:	e8 fd 1e 00 00       	call   38da <fork>
    if(pid < 0){
    ...
    1a00:	6a 00                	push   $0x0
    1a02:	53                   	push   %ebx
    1a03:	e8 1a 1f 00 00       	call   3922 <open>
    1a08:	89 04 24             	mov    %eax,(%esp)
    1a0b:	e8 fa 1e 00 00       	call   390a <close>
      close(open(file, 0));
    1a10:	58                   	pop    %eax
    1a11:	5a                   	pop    %edx
    1a12:	6a 00                	push   $0x0
    1a14:	53                   	push   %ebx
    1a15:	e8 08 1f 00 00       	call   3922 <open>
    1a1a:	89 04 24             	mov    %eax,(%esp)
    1a1d:	e8 e8 1e 00 00       	call   390a <close>
      close(open(file, 0));
    1a22:	59                   	pop    %ecx
    1a23:	58                   	pop    %eax
    1a24:	6a 00                	push   $0x0
    1a26:	53                   	push   %ebx
    1a27:	e8 f6 1e 00 00       	call   3922 <open>
    1a2c:	89 04 24             	mov    %eax,(%esp)
    1a2f:	e8 d6 1e 00 00       	call   390a <close>
      close(open(file, 0));
    1a34:	58                   	pop    %eax
    1a35:	5a                   	pop    %edx
    1a36:	6a 00                	push   $0x0
    1a38:	53                   	push   %ebx
    1a39:	e8 e4 1e 00 00       	call   3922 <open>
    1a3e:	89 04 24             	mov    %eax,(%esp)
    1a41:	e8 c4 1e 00 00       	call   390a <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1a71:	e8 ca 1f 00 00       	call   3a40 <printf>
      exit();
    1a76:	e8 67 1e 00 00       	call   38e2 <exit>
    ...
    exit();
    1a89:	e8 54 1e 00 00       	call   38e2 <exit>
    ...
    1ab0:	e8 8b 1f 00 00       	call   3a40 <printf>
        exit();
    1ab5:	e8 28 1e 00 00       	call   38e2 <exit>
      close(fd);
    1aba:	83 ec 0c             	sub    $0xc,%esp
    1abd:	50                   	push   %eax
    1abe:	e8 47 1e 00 00       	call   390a <close>
...
00001ad0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1aec:	e8 41 1e 00 00       	call   3932 <unlink>
  pid = fork();
    1af1:	e8 e4 1d 00 00       	call   38da <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b2d:	e8 00 1e 00 00       	call   3932 <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b62:	e8 bb 1d 00 00       	call   3922 <open>
    1b67:	89 04 24             	mov    %eax,(%esp)
    1b6a:	e8 9b 1d 00 00       	call   390a <close>
  ...
  if(pid)
    ...
    wait();
    1b7e:	e8 67 1d 00 00       	call   38ea <wait>
  printf(1, "linkunlink ok\n");
    ...
    1bad:	e8 90 1d 00 00       	call   3942 <link>
    ...
    exit();
    1bc8:	e8 15 1d 00 00       	call   38e2 <exit>
    exit();
    1bcd:	e8 10 1d 00 00       	call   38e2 <exit>
...
00001be0 <bigdir>:
{
  ...
  unlink("bd");
    ...
    1bfc:	e8 31 1d 00 00       	call   3932 <unlink>
  fd = open("bd", O_CREATE);
    1c01:	5a                   	pop    %edx
    1c02:	59                   	pop    %ecx
    1c03:	68 00 02 00 00       	push   $0x200
    1c08:	68 95 44 00 00       	push   $0x4495
    1c0d:	e8 10 1d 00 00       	call   3922 <open>
  if(fd < 0){
  ...
  close(fd);
    1c25:	50                   	push   %eax
    1c26:	e8 df 1c 00 00       	call   390a <close>
    ...
    if(link("bd", name) != 0){
    1c57:	e8 e6 1c 00 00       	call   3942 <link>
  ...
  unlink("bd");
    ...
    1c78:	e8 b5 1c 00 00       	call   3932 <unlink>
    ...
    if(unlink(name) != 0){
    1ca2:	e8 8b 1c 00 00       	call   3932 <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1cdd:	e8 5e 1d 00 00       	call   3a40 <printf>
      exit();
    1ce2:	e8 fb 1b 00 00       	call   38e2 <exit>
    ...
    1cf1:	e8 4a 1d 00 00       	call   3a40 <printf>
      exit();
    1cf6:	e8 e7 1b 00 00       	call   38e2 <exit>
    ...
    exit();
    1d09:	e8 d4 1b 00 00       	call   38e2 <exit>
...
00001d10 <subdir>:
{
  ...
  unlink("ff");
    ...
    1d2a:	e8 03 1c 00 00       	call   3932 <unlink>
  if(mkdir("dd") != 0){
    1d2f:	c7 04 24 08 46 00 00 	movl   $0x4608,(%esp)
    1d36:	e8 0f 1c 00 00       	call   394a <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d53:	e8 ca 1b 00 00       	call   3922 <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d6f:	50                   	push   %eax
    1d70:	e8 8d 1b 00 00       	call   3902 <write>
  close(fd);
    1d75:	89 1c 24             	mov    %ebx,(%esp)
    1d78:	e8 8d 1b 00 00       	call   390a <close>
  if(unlink("dd") >= 0){
    1d7d:	c7 04 24 08 46 00 00 	movl   $0x4608,(%esp)
    1d84:	e8 a9 1b 00 00       	call   3932 <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1d9c:	e8 a9 1b 00 00       	call   394a <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1db9:	e8 64 1b 00 00       	call   3922 <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1dd5:	50                   	push   %eax
    1dd6:	e8 27 1b 00 00       	call   3902 <write>
  close(fd);
    1ddb:	89 1c 24             	mov    %ebx,(%esp)
    1dde:	e8 27 1b 00 00       	call   390a <close>
  fd = open("dd/dd/../ff", 0);
    1de3:	58                   	pop    %eax
    1de4:	5a                   	pop    %edx
    1de5:	6a 00                	push   $0x0
    1de7:	68 62 45 00 00       	push   $0x4562
    1dec:	e8 31 1b 00 00       	call   3922 <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e0b:	50                   	push   %eax
    1e0c:	e8 e9 1a 00 00       	call   38fa <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  close(fd);
    ...
    1e2d:	53                   	push   %ebx
    1e2e:	e8 d7 1a 00 00       	call   390a <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e33:	5b                   	pop    %ebx
    1e34:	58                   	pop    %eax
    1e35:	68 a2 45 00 00       	push   $0x45a2
    1e3a:	68 3e 45 00 00       	push   $0x453e
    1e3f:	e8 fe 1a 00 00       	call   3942 <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e57:	e8 d6 1a 00 00       	call   3932 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e71:	e8 ac 1a 00 00       	call   3922 <open>
  ...
  if(chdir("dd") != 0){
    ...
    1e89:	e8 c4 1a 00 00       	call   3952 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1ea1:	e8 ac 1a 00 00       	call   3952 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1eb9:	e8 94 1a 00 00       	call   3952 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1ed1:	e8 7c 1a 00 00       	call   3952 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1eeb:	e8 32 1a 00 00       	call   3922 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f0a:	50                   	push   %eax
    1f0b:	e8 ea 19 00 00       	call   38fa <read>
  ...
  close(fd);
    ...
    1f1f:	53                   	push   %ebx
    1f20:	e8 e5 19 00 00       	call   390a <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f25:	59                   	pop    %ecx
    1f26:	5b                   	pop    %ebx
    1f27:	6a 00                	push   $0x0
    1f29:	68 3e 45 00 00       	push   $0x453e
    1f2e:	e8 ef 19 00 00       	call   3922 <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f4b:	e8 d2 19 00 00       	call   3922 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f68:	e8 b5 19 00 00       	call   3922 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f85:	e8 98 19 00 00       	call   3922 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1f9f:	e8 7e 19 00 00       	call   3922 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fb9:	e8 64 19 00 00       	call   3922 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fd6:	e8 67 19 00 00       	call   3942 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1ff3:	e8 4a 19 00 00       	call   3942 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2010:	e8 2d 19 00 00       	call   3942 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2028:	e8 1d 19 00 00       	call   394a <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2040:	e8 05 19 00 00       	call   394a <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2058:	e8 ed 18 00 00       	call   394a <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2070:	e8 bd 18 00 00       	call   3932 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2088:	e8 a5 18 00 00       	call   3932 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    20a0:	e8 ad 18 00 00       	call   3952 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    20b8:	e8 95 18 00 00       	call   3952 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20d0:	e8 5d 18 00 00       	call   3932 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    20e8:	e8 45 18 00 00       	call   3932 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2100:	e8 2d 18 00 00       	call   3932 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2118:	e8 15 18 00 00       	call   3932 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    2130:	e8 fd 17 00 00       	call   3932 <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    exit();
    2165:	e8 78 17 00 00       	call   38e2 <exit>
    ...
    exit();
    2178:	e8 65 17 00 00       	call   38e2 <exit>
    ...
    exit();
    218b:	e8 52 17 00 00       	call   38e2 <exit>
    ...
    exit();
    219e:	e8 3f 17 00 00       	call   38e2 <exit>
    ...
    exit();
    21b1:	e8 2c 17 00 00       	call   38e2 <exit>
    ...
    exit();
    21c4:	e8 19 17 00 00       	call   38e2 <exit>
    ...
    exit();
    21d7:	e8 06 17 00 00       	call   38e2 <exit>
    ...
    exit();
    21ea:	e8 f3 16 00 00       	call   38e2 <exit>
    ...
    exit();
    21fd:	e8 e0 16 00 00       	call   38e2 <exit>
    ...
    exit();
    2210:	e8 cd 16 00 00       	call   38e2 <exit>
    ...
    exit();
    2223:	e8 ba 16 00 00       	call   38e2 <exit>
    ...
    exit();
    2236:	e8 a7 16 00 00       	call   38e2 <exit>
    ...
    exit();
    2249:	e8 94 16 00 00       	call   38e2 <exit>
    ...
    exit();
    225c:	e8 81 16 00 00       	call   38e2 <exit>
    ...
    exit();
    226f:	e8 6e 16 00 00       	call   38e2 <exit>
    ...
    exit();
    2282:	e8 5b 16 00 00       	call   38e2 <exit>
    ...
    exit();
    2295:	e8 48 16 00 00       	call   38e2 <exit>
    ...
    exit();
    22a8:	e8 35 16 00 00       	call   38e2 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    22ad:	50                   	push   %eax
    22ae:	50                   	push   %eax
    ...
    exit();
    22bb:	e8 22 16 00 00       	call   38e2 <exit>
    ...
    exit();
    22ce:	e8 0f 16 00 00       	call   38e2 <exit>
    ...
    exit();
    22e1:	e8 fc 15 00 00       	call   38e2 <exit>
    ...
    exit();
    22f4:	e8 e9 15 00 00       	call   38e2 <exit>
    ...
    exit();
    2307:	e8 d6 15 00 00       	call   38e2 <exit>
    ...
    exit();
    231a:	e8 c3 15 00 00       	call   38e2 <exit>
    ...
    exit();
    232d:	e8 b0 15 00 00       	call   38e2 <exit>
    ...
    exit();
    2340:	e8 9d 15 00 00       	call   38e2 <exit>
    ...
    exit();
    2353:	e8 8a 15 00 00       	call   38e2 <exit>
    ...
    exit();
    2366:	e8 77 15 00 00       	call   38e2 <exit>
    ...
    exit();
    2379:	e8 64 15 00 00       	call   38e2 <exit>
    ...
    exit();
    238c:	e8 51 15 00 00       	call   38e2 <exit>
    ...
    exit();
    239f:	e8 3e 15 00 00       	call   38e2 <exit>
    ...
    exit();
    23b2:	e8 2b 15 00 00       	call   38e2 <exit>
    ...
    exit();
    23c5:	e8 18 15 00 00       	call   38e2 <exit>
    ...
    exit();
    23d8:	e8 05 15 00 00       	call   38e2 <exit>
    ...
    exit();
    23eb:	e8 f2 14 00 00       	call   38e2 <exit>
...
000023f0 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    2410:	e8 1d 15 00 00       	call   3932 <unlink>
    ...
    242d:	e8 f0 14 00 00       	call   3922 <open>
    if(fd < 0){
    ...
    2444:	50                   	push   %eax
    2445:	e8 b8 14 00 00       	call   3902 <write>
      if(cc != sz){
    ...
    245a:	56                   	push   %esi
    245b:	e8 a2 14 00 00       	call   3902 <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2470:	56                   	push   %esi
    2471:	e8 94 14 00 00       	call   390a <close>
    unlink("bigwrite");
    2476:	c7 04 24 04 48 00 00 	movl   $0x4804,(%esp)
    247d:	e8 b0 14 00 00       	call   3932 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    24af:	e8 8c 15 00 00       	call   3a40 <printf>
        exit();
    24b4:	e8 29 14 00 00       	call   38e2 <exit>
    ...
    24c3:	e8 78 15 00 00       	call   3a40 <printf>
      exit();
    24c8:	e8 15 14 00 00       	call   38e2 <exit>
...
000024d0 <bigfile>:
{
  ...
  unlink("bigfile");
    ...
    24ec:	e8 41 14 00 00       	call   3932 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    24f1:	58                   	pop    %eax
    24f2:	5a                   	pop    %edx
    24f3:	68 02 02 00 00       	push   $0x202
    24f8:	68 60 48 00 00       	push   $0x4860
    24fd:	e8 20 14 00 00       	call   3922 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2557:	56                   	push   %esi
    2558:	e8 ad 13 00 00       	call   390a <close>
  fd = open("bigfile", 0);
    255d:	5e                   	pop    %esi
    255e:	5f                   	pop    %edi
    255f:	6a 00                	push   $0x0
    2561:	68 60 48 00 00       	push   $0x4860
    2566:	e8 b7 13 00 00       	call   3922 <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    25bb:	56                   	push   %esi
    25bc:	e8 39 13 00 00       	call   38fa <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25cd:	56                   	push   %esi
    25ce:	e8 37 13 00 00       	call   390a <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25ea:	e8 43 13 00 00       	call   3932 <unlink>
  printf(1, "bigfile test ok\n");
    ...
    2612:	e8 29 14 00 00       	call   3a40 <printf>
      exit();
    2617:	e8 c6 12 00 00       	call   38e2 <exit>
    ...
    2626:	e8 15 14 00 00       	call   3a40 <printf>
      exit();
    262b:	e8 b2 12 00 00       	call   38e2 <exit>
    ...
    263a:	e8 01 14 00 00       	call   3a40 <printf>
      exit();
    263f:	e8 9e 12 00 00       	call   38e2 <exit>
    ...
    264e:	e8 ed 13 00 00       	call   3a40 <printf>
      exit();
    2653:	e8 8a 12 00 00       	call   38e2 <exit>
    ...
    exit();
    2666:	e8 77 12 00 00       	call   38e2 <exit>
    ...
    exit();
    2679:	e8 64 12 00 00       	call   38e2 <exit>
    ...
    exit();
    268c:	e8 51 12 00 00       	call   38e2 <exit>
...
000026a0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    26b9:	e8 8c 12 00 00       	call   394a <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26d1:	e8 74 12 00 00       	call   394a <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26ee:	e8 2f 12 00 00       	call   3922 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2701:	50                   	push   %eax
    2702:	e8 03 12 00 00       	call   390a <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2707:	58                   	pop    %eax
    2708:	5a                   	pop    %edx
    2709:	6a 00                	push   $0x0
    270b:	68 b8 51 00 00       	push   $0x51b8
    2710:	e8 0d 12 00 00       	call   3922 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    271f:	50                   	push   %eax
    2720:	e8 e5 11 00 00       	call   390a <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    2725:	c7 04 24 2c 49 00 00 	movl   $0x492c,(%esp)
    272c:	e8 19 12 00 00       	call   394a <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2740:	e8 05 12 00 00       	call   394a <mkdir>
  ...
  printf(1, "fourteen ok\n");
    ...
    exit();
    276e:	e8 6f 11 00 00       	call   38e2 <exit>
    ...
    exit();
    2781:	e8 5c 11 00 00       	call   38e2 <exit>
    ...
    exit();
    2794:	e8 49 11 00 00       	call   38e2 <exit>
    ...
    exit();
    27a7:	e8 36 11 00 00       	call   38e2 <exit>
    ...
    exit();
    27ba:	e8 23 11 00 00       	call   38e2 <exit>
    ...
    exit();
    27cd:	e8 10 11 00 00       	call   38e2 <exit>
...
000027e0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    27f9:	e8 4c 11 00 00       	call   394a <mkdir>
  ...
  if(unlink(".") == 0){
    ...
    2829:	e8 04 11 00 00       	call   3932 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2841:	e8 ec 10 00 00       	call   3932 <unlink>
  ...
  if(unlink("dots/.") == 0){
    ...
    2871:	e8 bc 10 00 00       	call   3932 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2885:	e8 a8 10 00 00       	call   3932 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    2899:	e8 94 10 00 00       	call   3932 <unlink>
  ...
  printf(1, "rmdot ok\n");
    ...
    exit();
    28c7:	e8 16 10 00 00       	call   38e2 <exit>
    ...
    exit();
    28da:	e8 03 10 00 00       	call   38e2 <exit>
    ...
    exit();
    28ed:	e8 f0 0f 00 00       	call   38e2 <exit>
    printf(1, "unlink dots/. worked!\n");
    28f2:	51                   	push   %ecx
    28f3:	51                   	push   %ecx
    ...
    exit();
    2900:	e8 dd 0f 00 00       	call   38e2 <exit>
    printf(1, "chdir / failed\n");
    2905:	50                   	push   %eax
    2906:	50                   	push   %eax
    ...
    exit();
    2913:	e8 ca 0f 00 00       	call   38e2 <exit>
    printf(1, "rm .. worked!\n");
    2918:	50                   	push   %eax
    2919:	50                   	push   %eax
    ...
    exit();
    2926:	e8 b7 0f 00 00       	call   38e2 <exit>
    printf(1, "rm . worked!\n");
    292b:	50                   	push   %eax
    292c:	50                   	push   %eax
    ...
    exit();
    2939:	e8 a4 0f 00 00       	call   38e2 <exit>
    ...
    exit();
    294c:	e8 91 0f 00 00       	call   38e2 <exit>
...
00002960 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    297f:	e8 9e 0f 00 00       	call   3922 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2992:	50                   	push   %eax
    2993:	e8 72 0f 00 00       	call   390a <close>
  if(chdir("dirfile") == 0){
  ...
  fd = open("dirfile/xx", 0);
    ...
    29b9:	e8 64 0f 00 00       	call   3922 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29d6:	e8 47 0f 00 00       	call   3922 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29ee:	e8 57 0f 00 00       	call   394a <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a06:	e8 27 0f 00 00       	call   3932 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a23:	e8 1a 0f 00 00       	call   3942 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2a3b:	e8 f2 0e 00 00       	call   3932 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a55:	e8 c8 0e 00 00       	call   3922 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a6f:	e8 ae 0e 00 00       	call   3922 <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2a80:	50                   	push   %eax
    2a81:	e8 7c 0e 00 00       	call   3902 <write>
  ...
  close(fd);
    ...
    2a90:	53                   	push   %ebx
    2a91:	e8 74 0e 00 00       	call   390a <close>
  printf(1, "dir vs file OK\n");
    ...
    exit();
    2aba:	e8 23 0e 00 00       	call   38e2 <exit>
    ...
    exit();
    2acd:	e8 10 0e 00 00       	call   38e2 <exit>
    ...
    exit();
    2ae0:	e8 fd 0d 00 00       	call   38e2 <exit>
    ...
    exit();
    2af3:	e8 ea 0d 00 00       	call   38e2 <exit>
    ...
    exit();
    2b06:	e8 d7 0d 00 00       	call   38e2 <exit>
    ...
    exit();
    2b19:	e8 c4 0d 00 00       	call   38e2 <exit>
    ...
    exit();
    2b2c:	e8 b1 0d 00 00       	call   38e2 <exit>
    ...
    exit();
    2b3f:	e8 9e 0d 00 00       	call   38e2 <exit>
    ...
    exit();
    2b52:	e8 8b 0d 00 00       	call   38e2 <exit>
    ...
    2b64:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b88:	e8 bd 0d 00 00       	call   394a <mkdir>
  ...
  printf(1, "empty file name OK\n");
    ...
    2c5d:	e8 de 0d 00 00       	call   3a40 <printf>
      exit();
    2c62:	e8 7b 0c 00 00       	call   38e2 <exit>
    ...
    2c71:	e8 ca 0d 00 00       	call   3a40 <printf>
      exit();
    2c76:	e8 67 0c 00 00       	call   38e2 <exit>
    2c7b:	90                   	nop
    ...
    2c84:	31 db                	xor    %ebx,%ebx
{
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2cad:	e8 28 0c 00 00       	call   38da <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2cc0:	e8 25 0c 00 00       	call   38ea <wait>
  ...
  if(wait() != -1){
    2cce:	e8 17 0c 00 00       	call   38ea <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    exit();
    2cff:	e8 de 0b 00 00       	call   38e2 <exit>
      exit();
    2d04:	e8 d9 0b 00 00       	call   38e2 <exit>
    ...
    2d13:	e8 28 0d 00 00       	call   3a40 <printf>
      exit();
    2d18:	e8 c5 0b 00 00       	call   38e2 <exit>
    ...
    exit();
    2d2b:	e8 b2 0b 00 00       	call   38e2 <exit>
    ...
    2d36:	31 ff                	xor    %edi,%edi
{
  ...
  a = sbrk(0);
    2d60:	e8 05 0c 00 00       	call   396a <sbrk>
  ...
  pid = fork();
    2d98:	e8 3d 0b 00 00       	call   38da <fork>
  if(pid < 0){
  ...
  wait();
    2dd3:	e8 12 0b 00 00       	call   38ea <wait>
  a = sbrk(0);
  ...
  *lastaddr = 99;
  ...
  c = sbrk(-(sbrk(0) - oldbrk));
    ...
    2eb0:	e8 b5 0a 00 00       	call   396a <sbrk>
  if(c != a){
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    2ec5:	e8 98 0a 00 00       	call   3962 <getpid>
    2eca:	89 c7                	mov    %eax,%edi
    pid = fork();
    2ecc:	e8 09 0a 00 00       	call   38da <fork>
    if(pid < 0){
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    wait();
    2ee5:	e8 00 0a 00 00       	call   38ea <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2ef8:	50                   	push   %eax
    2ef9:	e8 f4 09 00 00       	call   38f2 <pipe>
    ...
    2f21:	e8 d4 09 00 00       	call   38fa <read>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    if((pids[i] = fork()) == 0){
    2f33:	e8 a2 09 00 00       	call   38da <fork>
  ...
  c = sbrk(4096);
    ...
    2f9f:	50                   	push   %eax
    2fa0:	e8 6d 09 00 00       	call   3912 <kill>
    wait();
    2fa5:	e8 40 09 00 00       	call   38ea <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2fbd:	6a 00                	push   $0x0
    2fbf:	e8 a6 09 00 00       	call   396a <sbrk>
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    3002:	e8 db 08 00 00       	call   38e2 <exit>
    sbrk(-(sbrk(0) - oldbrk));
    3007:	83 ec 0c             	sub    $0xc,%esp
    300a:	6a 00                	push   $0x0
    300c:	e8 59 09 00 00       	call   396a <sbrk>
    3011:	29 c3                	sub    %eax,%ebx
    3013:	89 1c 24             	mov    %ebx,(%esp)
    3016:	e8 4f 09 00 00       	call   396a <sbrk>
    ...
    exit();
    3032:	e8 ab 08 00 00       	call   38e2 <exit>
    printf(1, "pipe() failed\n");
    3037:	52                   	push   %edx
    3038:	52                   	push   %edx
    ...
    exit();
    3045:	e8 98 08 00 00       	call   38e2 <exit>
    ...
    3062:	e8 ab 08 00 00       	call   3912 <kill>
      exit();
    3067:	e8 76 08 00 00       	call   38e2 <exit>
      printf(stdout, "fork failed\n");
    306c:	51                   	push   %ecx
    306d:	51                   	push   %ecx
    ...
    3079:	e8 c2 09 00 00       	call   3a40 <printf>
      exit();
    307e:	e8 5f 08 00 00       	call   38e2 <exit>
    ...
    exit();
    3095:	e8 48 08 00 00       	call   38e2 <exit>
    ...
    exit();
    30ac:	e8 31 08 00 00       	call   38e2 <exit>
    ...
    exit();
    30c3:	e8 1a 08 00 00       	call   38e2 <exit>
    ...
    exit();
    30da:	e8 03 08 00 00       	call   38e2 <exit>
    ...
    exit();
    310d:	e8 d0 07 00 00       	call   38e2 <exit>
    ...
    exit();
    3124:	e8 b9 07 00 00       	call   38e2 <exit>
    ...
    exit();
    313b:	e8 a2 07 00 00       	call   38e2 <exit>
...
00003150 <validatetest>:
{
  ...
  printf(stdout, "validate test\n");
    ...
    if((pid = fork()) == 0){
    3170:	e8 65 07 00 00       	call   38da <fork>
    ...
    317e:	6a 00                	push   $0x0
    3180:	e8 ed 07 00 00       	call   3972 <sleep>
    sleep(0);
    3185:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    318c:	e8 e1 07 00 00       	call   3972 <sleep>
    kill(pid);
    3191:	89 34 24             	mov    %esi,(%esp)
    3194:	e8 79 07 00 00       	call   3912 <kill>
    wait();
    3199:	e8 4c 07 00 00       	call   38ea <wait>
    if(link("nosuchfile", (char*)p) != -1){
    319e:	58                   	pop    %eax
    319f:	5a                   	pop    %edx
    31a0:	53                   	push   %ebx
    31a1:	68 4d 4c 00 00       	push   $0x4c4d
    31a6:	e8 97 07 00 00       	call   3942 <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    31dd:	c3                   	ret    
      exit();
    31de:	e8 ff 06 00 00       	call   38e2 <exit>
    ...
    31f1:	e8 4a 08 00 00       	call   3a40 <printf>
      exit();
    31f6:	e8 e7 06 00 00       	call   38e2 <exit>
    31fb:	90                   	nop
...
00003200 <bsstest>:
{
  ...
  printf(stdout, "bss test ok\n");
    ...
    3269:	e8 d2 07 00 00       	call   3a40 <printf>
      exit();
    326e:	e8 6f 06 00 00       	call   38e2 <exit>
...
00003280 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    328b:	e8 a2 06 00 00       	call   3932 <unlink>
  pid = fork();
    3290:	e8 45 06 00 00       	call   38da <fork>
  if(pid == 0){
  ...
  wait();
    32a2:	e8 43 06 00 00       	call   38ea <wait>
  fd = open("bigarg-ok", 0);
    32a7:	83 ec 08             	sub    $0x8,%esp
    32aa:	6a 00                	push   $0x0
    32ac:	68 a6 4c 00 00       	push   $0x4ca6
    32b1:	e8 6c 06 00 00       	call   3922 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32c4:	50                   	push   %eax
    32c5:	e8 40 06 00 00       	call   390a <close>
  unlink("bigarg-ok");
    32ca:	c7 04 24 a6 4c 00 00 	movl   $0x4ca6,(%esp)
    32d1:	e8 5c 06 00 00       	call   3932 <unlink>
}
    ...
    3318:	e8 fd 05 00 00       	call   391a <exec>
    ...
    333b:	e8 e2 05 00 00       	call   3922 <open>
    close(fd);
    3340:	89 04 24             	mov    %eax,(%esp)
    3343:	e8 c2 05 00 00       	call   390a <close>
    exit();
    3348:	e8 95 05 00 00       	call   38e2 <exit>
    ...
    exit();
    335f:	e8 7e 05 00 00       	call   38e2 <exit>
    ...
    exit();
    3376:	e8 67 05 00 00       	call   38e2 <exit>
    337b:	90                   	nop
    ...
    3386:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fsfull test\n");
    ...
    342a:	50                   	push   %eax
    342b:	e8 f2 04 00 00       	call   3922 <open>
    if(fd < 0){
    ...
    344f:	57                   	push   %edi
    3450:	e8 ad 04 00 00       	call   3902 <write>
      if(cc < 512)
    ...
    3472:	e8 93 04 00 00       	call   390a <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3519:	50                   	push   %eax
    351a:	e8 13 04 00 00       	call   3932 <unlink>
  while(nfiles >= 0){
...
00003550 <uio>:
{
  ...
  pid = fork();
    3562:	e8 73 03 00 00       	call   38da <fork>
  if(pid == 0){
  ...
  wait();
    3570:	e8 75 03 00 00       	call   38ea <wait>
  printf(1, "uio test done\n");
    ...
    exit();
    35a8:	e8 35 03 00 00       	call   38e2 <exit>
    printf (1, "fork failed\n");
    35ad:	50                   	push   %eax
    35ae:	50                   	push   %eax
    ...
    exit();
    35bb:	e8 22 03 00 00       	call   38e2 <exit>
...
000035c0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    35ce:	e8 4f 03 00 00       	call   3922 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    35df:	6a 00                	push   $0x0
    35e1:	e8 84 03 00 00       	call   396a <sbrk>
    35e6:	83 c4 0c             	add    $0xc,%esp
    35e9:	83 e8 01             	sub    $0x1,%eax
    35ec:	6a ff                	push   $0xffffffff
    35ee:	50                   	push   %eax
    35ef:	53                   	push   %ebx
    35f0:	e8 05 03 00 00       	call   38fa <read>
  close(fd);
    35f5:	89 1c 24             	mov    %ebx,(%esp)
    35f8:	e8 0d 03 00 00       	call   390a <close>
  printf(1, "arg test passed\n");
    ...
    exit();
    3621:	e8 bc 02 00 00       	call   38e2 <exit>
...
init_lock(struct spinlock * lk) {
  ...
  lk->locked = 0;
    ...
    3656:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
    365c:	5d                   	pop    %ebp
    365d:	c3                   	ret    
...
void unlock(struct spinlock * lk) {
    ...
    3685:	8b 55 08             	mov    0x8(%ebp),%edx
    3688:	f0 87 02             	lock xchg %eax,(%edx)
  xchg(&lk->locked, 0);
}
    368b:	5d                   	pop    %ebp
    368c:	c3                   	ret    
    ...
    39a9:	85 d2                	test   %edx,%edx
{
  ...
  write(fd, &c, 1);
    ...
    3a10:	e8 ed fe ff ff       	call   3902 <write>
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    3a80:	e8 7d fe ff ff       	call   3902 <write>
  ...
  write(fd, &c, 1);
    ...
    3ae1:	e8 1c fe ff ff       	call   3902 <write>
  ...
  write(fd, &c, 1);
    3afa:	e8 03 fe ff ff       	call   3902 <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    ...
    3b93:	57                   	push   %edi
    3b94:	53                   	push   %ebx
    3b95:	e8 68 fd ff ff       	call   3902 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    3be7:	e8 16 fd ff ff       	call   3902 <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3cfe:	56                   	push   %esi
    3cff:	e8 66 fc ff ff       	call   396a <sbrk>
  if(p == (char*)-1)
