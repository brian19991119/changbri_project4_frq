  ...
  a6:	31 db                	xor    %ebx,%ebx
{
 ...
 10d:	01 cb                	add    %ecx,%ebx
      if(strchr(" \r\t\n\v", buf[i]))
 10f:	e8 7c 01 00 00       	call   290 <strchr>
 ...
 4d9:	85 d2                	test   %edx,%edx
{
 ...
 540:	e8 ed fe ff ff       	call   432 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 5b0:	e8 7d fe ff ff       	call   432 <write>
 ...
 611:	e8 1c fe ff ff       	call   432 <write>
 ...
 628:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 62a:	e8 03 fe ff ff       	call   432 <write>
  for(i = 0; fmt[i]; i++){
 ...
 6c3:	57                   	push   %edi
 6c4:	53                   	push   %ebx
 6c5:	e8 68 fd ff ff       	call   432 <write>
        while(*s != 0){
 ...
 717:	e8 16 fd ff ff       	call   432 <write>
        ap++;
